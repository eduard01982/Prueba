...
Public Class LlamadorCaja

    Dim oCaja As New BLL.Caja
    Dim recienentro As Boolean = True

    Private Sub LlamadorCaja_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub NumeroDeCaja_SelectedItemChanged(sender As Object, e As EventArgs) Handles NumeroDeCaja.SelectedItemChanged
