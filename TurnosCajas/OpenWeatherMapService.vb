...
Public Class OpenWeatherMapService
    ...
    Private Const APP_ID As String = "490fe0b9d44c404e3b8df962d700c2d9"
    ...
    Public Async Function GetForecastAsync(location As String,
                                           days As Integer) As Task(Of IEnumerable(Of WeatherForecast)) Implements IWeatherService.GetForecastAsync
